...
export default function Header() {
  ...
  const toggleMobileMenu = (e) => {
    ...
    document
      .querySelector(".header__menu__mobile__wrapper")
      .classList.toggle("header__menu__mobile__wrapper-active");
    document
      .getElementById("logo_text")
      .classList.toggle("header__logo__text-active");
  };
  return (
    <header className="header">
      <div className="header__content section__container">
        ...
        <div onClick={toggleMobileMenu} className="header__burger">
          <div className="header__burger__line"></div>
          <div className="header__burger__line"></div>
          <div className="header__burger__line"></div>
        </div>
        <div className="header__menu__mobile__wrapper">
          <menu className="header__menu__mobile">
            <li className="header__menu__mobile__item">Features</li>
            <li className="header__menu__mobile__item">Pricing</li>
            <li className="header__menu__mobile__item">Contact</li>
            <button className="btn__transparent header__menu__mobile__btn">
              Login
            </button>
            <ul className="header__menu__mobile__socials">
              <li className="header__menu__mobile__socials__item">
